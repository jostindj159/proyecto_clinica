...
if (isset($_REQUEST["nombre_doctor"])){
  ...
  $nombre_doctor_vista = $nombre_doctor_;
}

$usuario_vista        = $_SESSION['usuario_vista'];
$nombre_doctor_vista  = $_SESSION['nombre_doctor_vista'];

if (isset($usuario_vista) and strlen($usuario_vista) > 0) {
  //echo "ESTOY EN USUARIO_VISTA $usuario_vista";
  $usuario_=$usuario_vista;
}
...
<body>
  ...
  <div class="container-fluid">
    <ul class="nav navbar-nav">
      <li class="active"><a href="index.php?accion=Panel">Panel</a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center"><h3>Doctor:<span class="label label-info"><?php echo $nombre_doctor_vista; ?></span>
        ...
        <div class="pull-right form-inline"><br>
            <button class="btn btn-info"><a href="index.php?accion=Panel">Volver al panel</a></button>
        </div>
        <!-- /.row -->
        <!-- Modal ========================================================-->
                ...
                <span class="label label-info" style="font-size: 18px;">Doctor:</span>
                  <div class="form-group">
                    ...
                    <select class="form-control" id="doctores" required="required" name="doctor">
                      <option value="<?php echo $usuario_vista;?>" ><?php echo $nombre_doctor_vista; ?>   </option>
                      <?php
                      Select(); 
                      /*if ($usuario_==1) {
                        Select();
