    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
         <form role="form" class="form-horizontal" method="post" action="../controller/c_cita.php?nonsense=1">
...
<input type="time" class="form-control" id="txtHora" name="txtHora" required="required">
...
<br /><br />
  <label>DNI:   </label>
  <input type="number" class="form-control" id="txtDNI" name="txtDNI" min="11111111" max="99999999" required="required"><br /><br />
<label>Nombre:</label>
  <input type="text" class="form-control" id="txtNombre" name="txtNombre" required="required"><br /><br />
