...
<div class="container">
 <div class="row">
<center>
 <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Doctores</button>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header" style="background-color:skyblue;">
          ...
          <h4 class="modal-title" style="color: white;">Lista de Doctores</h4>
        </div>
